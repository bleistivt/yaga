...
foreach ($this->data("Badges") as $badge) {
    ...
    if ($badge->Photo) {
        ...
        $row .= img("plugins/yaga/design/images/default_badge.png", [
            "class" => "BadgePhoto",
        ]);
    }
    ...
    $row .= wrap(
        wrap(
            ...
            wrap(
                wrap($badge->Description, "span", [
                    "class" => "MItem BadgeDescription",
                ]) .
                    wrap($badge->AwardValue . " points.", "span", [
                        "class" => "MItem BadgePoints",
                    ]) .
