...
<li id="<?php echo "{$px}_{$discussion->DiscussionID}"; ?>" class="<?php echo cssClass($discussion); ?>">
     <span class="Options">
        <?php //      echo optionsList($discussion);

    echo bookmarkButton($discussion); ?>
     </span>
     <div class="Title"><?php echo anchor(
     ...
     <div id="<?php echo "Promoted_{$contentType}_{$contentID}"; ?>" class="<?php echo cssClass($content); ?>">
            <div class="AuthorWrap">
                ...
                <span class="AuthorInfo">
                    ...
                    echo " " .
                        wrapIf(
                            htmlspecialchars($author["Title"] ?? ""),
                            "span",
                            ["class" => "MItem AuthorTitle"]
                        );
                    echo " " .
                        wrapIf(
                            htmlspecialchars($author["Location"] ?? ""),
                            "span",
            ...
            <div class="Meta CommentMeta CommentInfo">
                ...
                if ($source) {
                    echo wrap(
                        sprintf(
                            Gdn::translate("via %s"),
                            Gdn::translate($source . " Source", $source)
                        ),
                        "span",
                        ["class" => "MItem Source"]
                    );
