...
<?php echo subheading(Gdn::translate("Yaga.Perks")); ?>
<ul>
    <li class="form-group">
        <div class="label-wrap">
        ...
        <div class="input-wrap">
            <?php echo $this->Form->dropdown("Role", $this->data("Roles"), [
                "IncludeNull" => true,
            ]); ?>
        </div>
    </li>
    <li class="form-group">
    <?php echo renderPerkConfigurationForm(
        "Garden.EditContentTimeout",
        "Yaga.Perks.EditTimeout",
        [
            "0" => Gdn::translate("Authors may never edit"),
            "350" => sprintf(
                Gdn::translate("Authors may edit for %s"),
                Gdn::translate("5 minutes")
            ),
            "900" => sprintf(
                Gdn::translate("Authors may edit for %s"),
                Gdn::translate("15 minutes")
            ),
            "3600" => sprintf(
                Gdn::translate("Authors may edit for %s"),
    ...
    <li class="form-group">
        <?php echo renderPerkPermissionForm(
    ...
    <li class="form-group">
        <?php echo renderPerkConfigurationForm(
            "Plugins.Emotify.FormatEmoticons",
            "Yaga.Perks.Emoticons"
        ); ?>
    </li>
    <li class="form-group">
        <?php echo renderPerkConfigurationForm(
            "Garden.Format.MeActions",
            "Yaga.Perks.MeActions"
        ); ?>
    </li>
    <?php $this->fireEvent("PerkOptions"); ?>
</ul>
