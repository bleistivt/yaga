...
foreach ($this->data("Icons") as $icon) {
    ...
    $icons .= img("plugins/yaga/design/images/action-icons/" . $icon . ".png", [
        "title" => $icon,
        "data-class" => $class,
        "class" => $selected,
    ]);
...
<ul>
    ...
    <li class="form-group">
        <div class="label-wrap">
            ...
            echo wrap(Gdn::translate("Yaga.Action.PhotoDesc"), "div", [
                "class" => "info",
            ]);
    ...
    <li class="form-group">
        <div class="label-wrap">
            ...
            echo wrap(Gdn::translate("Yaga.Action.EmojiDesc"), "div", [
                "class" => "info",
            ]);
            ?>
        </div>
    ...
    <li class="form-group">
        <div class="label-wrap">
            ...
            echo wrap(Gdn::translate("Yaga.Action.CssDesc"), "div", [
                "class" => "info",
            ]);
            ?>
        </div>
    ...
    <li class="form-group">
        <div class="label-wrap">
            ...
            echo wrap(Gdn::translate("Yaga.Action.PermDesc"), "div", [
                "class" => "info",
            ]);
            ?>
        </div>
