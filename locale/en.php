...
$Definition['Yaga.Action.ConfirmDelete'] = 'Are you sure you want to delete the <em>%s</em> reaction?';
...
$Definition['Yaga.Action.PermDesc'] = "A user will need the following permission to use this reaction. The default is 'Yaga.Reactions.Add'.";
...
$Definition['Yaga.Action.IconHelpContent'] = 'If you do not want to use your own icons or Emoji, YAGA\'s default stylesheet ships with many to choose from. Clicking any of the icons below will set the corresponding CSS class. No need to upload images!';
$Definition['Yaga.Action.PhotoDesc'] = 'You can add an icon for this reaction here. It is recommended to use a graphic of at least 16 by 16 pixels. If you want the reaction to look good on any device, use 48 by 48 pixels. You may also use SVG graphics.';
$Definition['Yaga.Action.EmojiDesc'] = 'If you would rather use emoji as reaction icons, you may insert one (e.g. "😂") here, otherwise leave this field empty.';
