...
$Definition["Yaga.MenuLinks.Show"] =
    "Show links in the main menu that describe your Yaga configuration";

// Actions
$Definition["Yaga.Action"] = "Reaction";
$Definition["Yaga.Action.Add"] = "Add Reaction";
$Definition["Yaga.Action.Added"] = "Reaction added successfully!";
$Definition["Yaga.Action.ConfirmDelete"] =
    "Are you sure you want to delete the <em>%s</em> reaction?";
$Definition["Yaga.Action.Delete"] = "Delete Reaction";
$Definition["Yaga.Action.Edit"] = "Edit Reaction";
$Definition["Yaga.Action.Invalid"] = "Invalid Reaction";
...
$Definition["Yaga.Action.PermDesc"] =
    "A user will need the following permission to use this reaction. The default is 'Yaga.Reactions.Add'.";
$Definition["Yaga.ActionUpdated"] = "Reaction updated successfully!";
$Definition["Yaga.Action.PhotoDeleted"] = "Reaction photo has been deleted.";
$Definition["Yaga.Action.IconHelpTitle"] = "Looking for React Icons?";
$Definition["Yaga.Action.IconHelpContent"] =
    'If you do not want to use your own icons or Emoji, YAGA\'s default stylesheet ships with many to choose from. Clicking any of the icons below will set the corresponding CSS class. No need to upload images!';
$Definition["Yaga.Action.PhotoDesc"] =
    "You can add an icon for this reaction here. It is recommended to use a graphic of at least 16 by 16 pixels. If you want the reaction to look good on any device, use 48 by 48 pixels. You may also use SVG graphics.";
$Definition["Yaga.Action.EmojiDesc"] =
    'If you would rather use emoji as reaction icons, you may insert one (e.g. "😂") here, otherwise leave this field empty.';
$Definition["Yaga.Action.CssDesc"] =
    "Use this if you would rather style your reaction through CSS.";
$Definition["Yaga.Actions.Current"] = "Current Reactions";
$Definition["Yaga.Actions.Desc"] =
    "Reactions are shown underneath user generated content such as discussions, comments, and activity items. Users can select one reaction per post. The owner of the original item will receive points based on the reactions of others. This forms a positive feedback loop for both positive <em>and</em> negative reactions.";
$Definition["Yaga.Actions.Manage"] = "Manage Reactions";
$Definition["Yaga.Actions.Settings.Desc"] =
    "You can manage the available reactions here. Drag items to sort their display order.";
...
$Definition["Yaga.Badge.EarnedHeadlineFormat"] =
    '{ActivityUserID,You} earned the <a href="{Url,html}">{Data.Name,text}</a> badge.';
...
$Definition["Yaga.Badges.Desc"] =
    "Badges are awarded to users that meet the criteria defined by the associated rules. They are recorded to their user profile and also award points. They can be used to create an achievement system that re-enforces good user behavior.";
...
$Definition["Yaga.Badges.Settings.Desc"] =
    "You can manage the available badges here. Disabled badges will not be awarded automatically.";
...
$Definition["Yaga.BestContent.MinPoints"] =
    'Minimum amount of points needed for "Best Of..."';

// Errors
$Definition["Yaga.Error.AddFile"] = "Unable to add file: %s";
$Definition["Yaga.Error.ArchiveChecksum"] =
    "Archive appears to be corrupt: Checksum is invalid.";
...
$Definition["Yaga.Error.Includes"] =
    "You must select at least one item to transport.";
...
$Definition["Yaga.Error.NoBadges"] =
    "You cannot award badges without any badges defined.";
$Definition["Yaga.Error.NoRanks"] =
    "You cannot promote users without any ranks defined.";
$Definition["Yaga.Error.NoRules"] =
    "You cannot add or edit badges without rules!";
...
$Definition["Yaga.Error.TransportRequirements"] =
    "You do not seem to have the minimum requirements to transport a Yaga configuration automatically. Please reference manual_transport.md for more information.";
...
$Definition["Yaga.Rank.Photo.Desc"] =
    "This photo will be shown on activity posts and in notifications concerning rank progression.";
$Definition["Yaga.Rank.PhotoDeleted"] = "Rank photo has been deleted.";
$Definition["Yaga.Rank.PhotoUploaded"] =
    "Rank photo has been uploaded successfully!";
$Definition["Yaga.Rank.Progression"] = "Rank Progression";
$Definition["Yaga.Rank.Progression.Desc"] =
    "Allow user to automatically progress past this rank.";
...
$Definition["Yaga.Rank.PromotedHeadlineFormat"] =
    "{ActivityUserID,You} earned a promotion to {Data.Name,text}.";
$Definition["Yaga.Rank.RecordActivity"] =
    "Record this rank edit to the public activity log.";
...
$Definition["Yaga.Ranks.Desc"] =
    "Ranks are awarded to users based on their account age, accumulated points, and total posts. Ranks have associated perks that can be used to alter the user's experience.";
...
$Definition["Yaga.Ranks.RequiredAgeFormat"] =
    "Account must be at least %s old.";
$Definition["Yaga.Ranks.Settings.Desc"] =
    "You can manage the available ranks here. Disabled ranks will not be awarded automatically. Drag items to sort the promotion order.";
$Definition["Yaga.Ranks.Use"] = "Use Ranks";
$Definition["Yaga.Ranks.Story.Manual"] = "This rank is given out manually";
$Definition["Yaga.Ranks.Story.Auto"] =
    "This rank will be automatically awarded";
...
$Definition["Yaga.Ranks.Story.3Reqs"] =
    "This rank will be awarded once your account %s, %s, and %s";
$Definition["Yaga.Ranks.Story.2Reqs"] =
    "This rank will be awarded once your account %s and %s";
$Definition["Yaga.Ranks.Story.1Reqs"] =
    "This rank will be awarded once your account %s";
...
$Definition["Yaga.Rules.AwardCombo.Desc"] =
    "Award this badge if the count of unique badge awards (based on rule) a user received within the past time frame meets or exceeds the target criteria.";
$Definition["Yaga.Rules.CakeDayPost"] = "Cake Day Post";
$Definition["Yaga.Rules.CakeDayPost.Desc"] =
    "Award this badge if the user posts on their account anniversary.";
...
$Definition["Yaga.Rules.CommentCount.Desc"] =
    "Award this badge if the total count of comments a user has ever made meets or exceeds the target criteria.";
...
$Definition["Yaga.Rules.CommentMarathon.Desc"] =
    "Award this badge if the number of comments a user has made in the past time frame meets or exceeds the target criteria.";
...
$Definition["Yaga.Rules.DiscussionBodyLength.Desc"] =
    "Award this badge if the user has a discussion that reaches the target number of characters. Make sure you enter a number less than or equal to %s.";
...
$Definition["Yaga.Rules.DiscussionCategory.Desc"] =
    "Award this badge if the user has started a discussion in the specified category.";
...
$Definition["Yaga.Rules.DiscussionPageCount.Desc"] =
    "Award this badge if the user has a discussion that reaches the target number of pages.";
...
$Definition["Yaga.Rules.HolidayVisit.Desc"] =
    "Award this badge if the user visits on the same day of the year as the specified date.";
...
$Definition["Yaga.Rules.ManualAward.Desc"] =
    "This badge will <strong>never</strong> be awarded <em>automatically</em>. Use it for badges you want to hand out manually.";
$Definition["Yaga.Rules.NecroPost"] = "Necro-Post Check";
$Definition["Yaga.Rules.NecroPost.Criteria.Head"] =
    "How old is a dead disussion?";
$Definition["Yaga.Rules.NecroPost.Desc"] =
    "Award this badge if the user has commented on a dead discussion.";
...
$Definition["Yaga.Rules.PostCount.Desc"] =
    "Award this badge if the total count of comments and/or discussions a user has ever made meets or exceeds the target criteria.";
...
$Definition["Yaga.Rules.PostReactions.Desc"] =
    "Award this badge if the user has a single post with the specified reaction counts.";
$Definition["Yaga.Rules.PostReactions.LabelFormat"] = "# of %s's:";
$Definition["Yaga.Rules.QnAAnserCount"] =
    "Accepted Answers (QnA Plugin required)";
$Definition["Yaga.Rules.QnAAnserCount.Criteria.Head"] =
    "How many accepted answers?";
...
$Definition["Yaga.Rules.ReactionCount.Desc"] =
    "Award this badge if the user has received x total reactions of the type specified.";
...
$Definition["Yaga.Rules.ReflexComment.Desc"] =
    "Award this badge if a comment is placed within x seconds of its discussion's creation.";
...
$Definition["Yaga.Rules.UnknownRule.Desc"] =
    "This badge will <strong>never</strong> be awarded <em>automatically</em>. This is selected if the rule class saved in the database is no longer available. This is most likely due to a plugin providing a rule and no longer being enabled.";

// Transport
$Definition["Yaga.Export"] = "Export Yaga Configuration";
$Definition["Yaga.Export.Desc"] =
    "You can export your existing Yaga configuration for backup or transport purposes. Select which sections of your Yaga configuration should be exported.";
$Definition["Yaga.Export.Success"] =
    "Your Yaga configuration was successfully exported to: <strong>%s</strong>";
$Definition["Yaga.Import"] = "Import Yaga Configuration";
$Definition["Yaga.Import.Desc"] =
    "You can import a Yaga configuration to <strong>replace</strong> your current configuration. Select which sections of your Yaga configuration should be <strong>overwritten</strong>.";
$Definition["Yaga.Import.Success"] =
    "You successfully overwrote your Yaga configuration with the contents of: <strong>%s</strong>";
$Definition["Yaga.Transport"] = "Import / Export Configuration";
$Definition["Yaga.Transport.Desc"] =
    "You can use these tools to facilitate transport of your Yaga configuration across sites with a convenient single file transfer.";
