...
if (!$row) {
    $sql->insert("YagaAction", [
        ...
        "Name" => "Promote",
        "Tooltip" =>
            "Click me if this content should be featured on the best of page!",
...
if (!$row) {
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#anniversary-1",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#anniversary-3",
        "RuleClass" => "LengthOfService",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#anniversary-4",
        "RuleClass" => "LengthOfService",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#anniversary-5",
        "RuleClass" => "LengthOfService",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#anniversary-longtime",
        "RuleClass" => "LengthOfService",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#fb-connector",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#insightful-1",
        "RuleClass" => "ReactionCount",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Description" => "You keep posting great content. Nice!",
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#insightful-2",
        "RuleClass" => "ReactionCount",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Description" => "Your posts are what good forums are made of!",
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#insightful-3",
        "RuleClass" => "ReactionCount",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Description" =>
            "We definitely want you to keep doing what you are doing.",
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#insightful-4",
        "RuleClass" => "ReactionCount",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Description" => 'We\'re lucky to have you here. Amazing!',
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#insightful-5",
        "RuleClass" => "ReactionCount",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#moon-landing",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#portrait-upload",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#achievement-combo",
    ...
    $sql->insert("YagaBadge", [
        "Name" => "Post Marathon",
        "Description" =>
            "I am tired just looking at all the stuff you are doing!",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#threadshot-reticle",
    ...
    $sql->insert("YagaBadge", [
        "Name" => "Twitterpated",
        "Description" =>
            "Make way for the retweets, hash tags, and restrictive message length. It is refreshing to see well crafted messages make every character cou",
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#twitter-connector",
        "RuleClass" => "SocialConnection",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Description" =>
            "You should try to bring humans back to life now that you have brought this discussion back from the dead.",
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#unimpressed-necropost",
        "RuleClass" => "NecroPost",
    ...
    $sql->insert("YagaBadge", [
        ...
        "Photo" =>
            "/plugins/yaga/design/images/default_badges.svg#welcome-committee",
...
if (!$row) {
    $sql->insert("YagaRank", [
        ...
        "AgeReq" => 0,
        "Perks" =>
            '{"ConfGarden.EditContentTimeout":"0","PermGarden.Curation.Manage":"revoke","PermPlugins.Signatures.Edit":"revoke","PermPlugins.Tagging.Add":"revoke","ConfPlugins.Emotify.FormatEmoticons":"0","ConfGarden.Format.MeActions":"0"}',
    ]);
    $sql->insert("YagaRank", [
        "RankID" => 2,
        "Name" => "Level 2",
        ...
        "AgeReq" => 86400,
        "Perks" =>
            '{"ConfGarden.EditContentTimeout":"0","PermGarden.Curation.Manage":"revoke","PermPlugins.Signatures.Edit":"revoke","PermPlugins.Tagging.Add":"revoke"}',
    ]);
    $sql->insert("YagaRank", [
        "RankID" => 3,
        "Name" => "Level 3",
        ...
        "AgeReq" => 604800,
        "Perks" =>
            '{"ConfGarden.EditContentTimeout":"0","ConfPlugins.Emotify.FormatEmoticons":"1","ConfGarden.Format.MeActions":"1"}',
    ]);
    $sql->insert("YagaRank", [
        "RankID" => 4,
        "Name" => "Level 4",
        ...
        "AgeReq" => 2678400,
        "Perks" =>
            '{"ConfGarden.EditContentTimeout":"604800","PermPlugins.Signatures.Edit":"grant","ConfPlugins.Emotify.FormatEmoticons":"1","ConfGarden.Format.MeActions":"1"}',
    ]);
    $sql->insert("YagaRank", [
        "RankID" => 5,
        "Name" => "Level 5",
        ...
        "AgeReq" => 7776000,
        "Perks" =>
            '{"ConfGarden.EditContentTimeout":"2592000","PermGarden.Curation.Manage":"grant","PermPlugins.Signatures.Edit":"grant","PermPlugins.Tagging.Add":"grant","ConfPlugins.Emotify.FormatEmoticons":"1","ConfGarden.Format.MeActions":"1"}',
    ]);
    $sql->insert("YagaRank", [
        "RankID" => 6,
        "Name" => "Moderator",
    ...
    $sql->insert("YagaRank", [
        ...
        "AgeReq" => 157766400,
        "Perks" =>
            '{"Role":"16","ConfGarden.EditContentTimeout":"-1","PermGarden.Curation.Manage":"grant","PermPlugins.Signatures.Edit":"grant","PermPlugins.Tagging.Add":"grant","ConfPlugins.Emotify.FormatEmoticons":"1","ConfGarden.Format.MeActions":"1"}',
        "Enabled" => 0,
    ]);
}
